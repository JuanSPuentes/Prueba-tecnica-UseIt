...
from .views import AceptarInvitacion, CreateEmpresa, CreateEmpresaCliente, CreateInvitaciones, DeleteEmpresa, DeleteUsuarioInvitado, ListEmpresa, ListEmpresaCliente, ListInvitaciones, ListUsuarios, RechazarInvitacion, UpdateEmpresa, json_load
app_name = "empresa"
